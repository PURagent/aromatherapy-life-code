...
const page = figma.root.children.find(p => p.name === '03 · The Celestial Sanctuary');
if (!page) throw new Error('Native design page was not found.');
await figma.setCurrentPageAsync(page);
const roots = page.children.filter(n => n.name === 'Fantasy Desktop · 1440' || n.name === 'Fantasy Mobile · 390');
...
const desktop = roots.find(n => n.name === 'Fantasy Desktop · 1440');
const hero = desktop && desktop.children.find(n => n.name === 'Portal Hero');
